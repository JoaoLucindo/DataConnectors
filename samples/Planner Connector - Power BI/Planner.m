...
shared PlannerTasks.WebContents = (MyURL as text) =>
   let
       source = Web.Contents(MyURL),
...
PlannerTasks = [
    TestConnection = (dataSourcePath) => { "PlannerTasks.WebContents" },
    Authentication = [
        OAuth = [
...
PlannerTasks.UI = [
    Beta = true,
    ButtonText = { "PlannerTasks.WebContents", "Connect to Planner" },
    SourceImage = MyPlannerConnector.Icons,
    SourceTypeImage = MyPlannerConnector.Icons
];

MyPlannerConnector.Icons = [
    Icon16 = { Extension.Contents("graphapi16.png"), Extension.Contents("graphapi20.png"), Extension.Contents("graphapi24.png"), Extension.Contents("graphapi.png") },
    Icon32 = { Extension.Contents("graphapi32.png"), Extension.Contents("graphapi40.png"), Extension.Contents("graphapi.png"), Extension.Contents("graphapi.png") }
];
